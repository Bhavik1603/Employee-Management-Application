...
{
super("Designation Manager by Bhavik Mundra");
initComponents();
addListeners();
setAppearance();
setViewMode();
...
{
logoIcon = new ImageIcon("F://JavaProjects//HR//PL//src//main//resources//icons//favicon.png");
...
{
if(blException.hasException("title"))JOptionPane.showMessageDialog(this, blException.getException("title"));
}
}
titleTextField.requestFocus();
return false;
